...
if has("cscope")
    ...
    set cscopetag
    " This hacks for jumping to protoype - ctrl-] jumps to proto & ctrl-\,g
    " jumps to definition
    "set nocscopetag
    ...
    command -nargs=+ Cse cs find e <args>
    command -nargs=+ Csd cs find d <args>
    command -nargs=+ Csa cs find a <args>

    " Update cscope db from vim
    "nmap <F10> :!cscope -q -R -b -i ./.git/hooks/cscope.files -f ./.git/hooks/cscope.out<CR>:cscope reset<CR><CR>:!ctags -R --c-kinds=+p --fields=+iaS --extras=+q -L ./.git/hooks/cscope.files -o ./.git/hooks/tags<CR><CR>
